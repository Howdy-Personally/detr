...
```
python main.py --coco_path ./animal --output ./outputanimal --epoch=1000 --num_classes=10
```
...
## Detection
```
python main.py --no_aux_loss --detect --resume ./outputanimal/checkpoint0999.pth --coco_path ./animal --num_classes=10
```
